...
<section class="relative flex min-h-dvh items-center overflow-hidden bg-surface-dark">
	...
	<div class="relative mx-auto w-full min-w-0 max-w-7xl px-6 py-8 sm:py-32">
		<div class="mx-auto max-w-4xl text-center h-screen sm:h-auto flex flex-col justify-center">
